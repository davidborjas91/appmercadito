...
<body id="top" class="scrollspy">
    ...
    <script type="text/javascript">
        ...
        function geo() { //user click on button
...
-->
    ...
    ?>
        <!--Se agreso un sweetalert2 para el manejo de las alertas en pantalla-->
        ...
        <script type="text/javascript">
            ...
            Swal.fire({
                title: 'Inicia tu sesion para obtener una mejor experiencia...',
                ...
                if (result.isConfirmed) {
                    ...
                    window.location="http://localhost:8086/appmercadito/pedidos/login.php";
                } 
            });
        </script>
    <?php
